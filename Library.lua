...
local Library = {
    ...
    AccentColor = Color3.fromRGB(90, 175, 220);
...
Library.BlurEffect.Name = "UELinoriaBlur"
...
function Library:AddToolTip(InfoStr, HoverInstance)
    ...
    Library:ApplyCornerRadius(Tooltip, 3);
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        Library:ApplySurfaceSheen(HueBoxInner);
...
do
    ...
    function Funcs:AddButton(...)
        ...
        local function CreateBaseButton(Button)
            ...
            Library:ApplySurfaceSheen(Inner);
    ...
    function Funcs:AddDivider()
        ...
        Library:ApplyCornerRadius(DividerOuter);
        Library:ApplyCornerRadius(DividerInner);
        Groupbox:AddBlank(9);
        Groupbox:Resize();
    end
    ...
    function Funcs:AddInput(Idx, Info)
        ...
        Library:ApplySurfaceSheen(TextBoxInner);
        Library:ApplyCornerRadius(TextBoxOuter);
        Library:ApplyCornerRadius(TextBoxInner);
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        Library:ApplyCornerRadius(ToggleOuter, 2);
        Library:ApplyCornerRadius(ToggleInner, 2);
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        Library:ApplyCornerRadius(SliderOuter, 2);
        Library:ApplyCornerRadius(SliderInner, 2);
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        Library:ApplySurfaceSheen(DropdownInner);
        ...
        Library:ApplyCornerRadius(ListInner, 3);
...
do
    ...
    Library:ApplyCornerRadius(KeybindOuter);
    ...
    Library:ApplyCornerRadius(KeybindInner, 3);
...
function Library:CreateWindow(...)
    ...
    if type(Config.TabPadding) ~= 'number' then Config.TabPadding = 14 end
    ...
    local HEADER_H = 22;
    local TAB_H = 22;
    local CONTENT_TOP = 48;

    local WindowLabel = Library:CreateLabel({
        Position = UDim2.new(0, SIDE_PAD, 0, 0);
        Size = UDim2.new(1, -SIDE_PAD * 2, 0, HEADER_H);
    ...
    local TabArea = Library:Create('Frame', {
        BackgroundTransparency = 1;
        Position = UDim2.new(0, SIDE_PAD, 0, HEADER_H);
        Size = UDim2.new(1, -SIDE_PAD * 2, 0, TAB_H);
        ZIndex = 1;
        Parent = Inner;
    });
    ...
    local TabDivider = Library:Create('Frame', {
        BackgroundColor3 = Library.AccentColor;
        BorderSizePixel = 0;
        Position = UDim2.new(0, SIDE_PAD, 0, HEADER_H + TAB_H + 2);
        Size = UDim2.new(1, -SIDE_PAD * 2, 0, 1);
        ZIndex = 2;
        Parent = Inner;
    });
    ...
    local TabContainer = Library:Create('Frame', {
        BackgroundTransparency = 1;
        Position = UDim2.new(0, SIDE_PAD, 0, CONTENT_TOP);
        Size = UDim2.new(1, -SIDE_PAD * 2, 1, -(CONTENT_TOP + SIDE_PAD));
        ZIndex = 2;
        Parent = Inner;
    });
    ...
    function Window:AddTab(Name)
        ...
        local TabButton = Library:Create('Frame', {
            BackgroundTransparency = 1;
            BorderSizePixel = 0;
            Size = UDim2.new(0, TabButtonWidth + 2, 1, 0);
            ZIndex = 1;
            Parent = TabArea;
        });
        ...
        function Tab:AddTabbox(Info)
            ...
            function Tabbox:AddTab(Name)
                ...
                local Button = Library:Create('Frame', {
                    BackgroundTransparency = 1;
                    BorderSizePixel = 0;
                    Size = UDim2.new(0, Library:GetTextBounds(Name, Library.Font, Library.FontSize) + 2, 1, 0);
                    ZIndex = 6;
                    Parent = TabboxButtons;
                });
